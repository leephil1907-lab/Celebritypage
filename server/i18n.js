...
const DICT = {
  ...
  'sec.shows': ['公演アーカイブ', 'Show Archive'],
  'sec.wall': ['ファンウォール', 'Fan Wall'],
  'sec.lottery': ['ミーグリ抽選', 'Meet & Greet Lottery'],
  'sec.countdown': ['次公演まで', 'Countdown to the Next Show'],
  'cta.calendar': ['カレンダーに追加', 'Add to Calendar'],
  'cta.allShows': ['公演一覧へ', 'All shows'],
  'cta.enterDraw': ['抽選に参加', 'Enter the Draw'],
  'cta.checkin': ['会場チェックイン', 'Check In at the Venue'],
  'cta.postNote': ['ノートを送る', 'Leave a Note'],
  'cta.applause': ['拍手', 'Applaud'],
  'cta.notify': ['発売を知らせる', 'Notify me'],
  'cta.winners': ['当番発表', 'Draw Results'],
